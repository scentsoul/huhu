...
void my_err(const char *err_string, int line);      //打印错误信息
void sort_time(char a[256][PATH_MAX+1], int left, int right,char mm[256][PATH_MAX]);  //排序
int face(int argc, char ** argv);                    //开始处
void print_dir(char *path);                          //-R的循环函数
